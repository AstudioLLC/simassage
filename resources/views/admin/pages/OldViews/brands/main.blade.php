...
@section('titleSuffix')
    |
    <a href="{!! route('admin.brands.add') !!}" class="text-cyan">
                ...
                <table class="table table-striped m-b-0 columns-middle">
                    ...
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            @endif
                            <td>
                                <a href="{{ route('admin.brands.edit', ['id'=>$item->id]) }}" {!! tooltip(t('Admin action buttons.edit')) !!} class="icon-btn edit"></a>
...
@push('js')
    <script>
        ...
        modal.on('show.bs.modal', function(e){
            ...
            modalTitle.html(thisItemRow.find('.page-title').html());
