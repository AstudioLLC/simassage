        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                ...
                <div class="card px-3 pt-3">
                    ...
                    <div class="d-flex mt-2">
                        <div class="mr-2">
                            @labelauty(['id'=>'active', 'label'=>t('Admin pages form.inactive')."|".t('Admin pages form.active'), 'checked'=> oldCheck('active', true)])@endlabelauty
                        </div>
                        <div class="mr-2">
                            @labelauty(['id'=>'is_new', 'label'=>t('Admin pages form.new'), 'checked'=> oldCheck('is_new', false)])@endlabelauty
                        </div>
                        <div class="mr-2">
                            @labelauty(['id'=>'is_promotion', 'label'=>t('Admin pages form.promotion'), 'checked'=> oldCheck('is_promotion', false)])@endlabelauty
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12 mt-3">
                <div class="card">
                    ...
                    <label class="w-100">
                        <textarea class="form-control form-textarea" name="short[{!! $iso !!}]">
                            {!! old('short.'.$iso, tr($item, 'short', $iso)) !!}
                        </textarea>
                    </label>
                    @endbylang
                </div>
            ...
            <div class="col-12">
                <div class="card p-2">
                    ...
                    <div class="row w-100 px-2">
                        @if(old('options') && count(old('options')['name']) > 0)
                            <div class="w-100">
                                    ...
                                    <div class="inputs_for_index d-flex">
                                        <div class="col-12 col-lg-6">
                                            <input placeholder="{{ t('Admin items.specifications name') }}"
                                                   ...
                                                   name="options[name][{{$loop->index}}][{!! $iso !!}]"
                                                   type="text"
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <input placeholder="{{ t('Admin items.specifications value') }}"
                                                   class="form-control characteristics-inputs"
                                                   name="options[value][{{$loop->index}}][{!! $iso !!}]"
                                                   type="text"
                                                   data-index="{{$loop->index}}"
