...
@section('titleSuffix')
    |
    <a href="{!! route('admin.news.add') !!}" class="text-cyan">
        ...
        <div class="card">
            <div class="table-responsive p-2">
                <table class="table table-striped m-b-0 columns-middle">
                    ...
                    <tbody class="table-sortable" data-action="{{ route('admin.news.sort') }}">
                    @foreach($items as $item)
                        <tr class="item-row" data-id="{!! $item->id !!}">
                            ...
                            <td>
                                ...
                                <a href="{{ route('admin.gallery.show', ['gallery'=>'news_item', 'id' => $item->id]) }}"
