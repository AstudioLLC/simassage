@push('js')
    <script>
        ...
        /**
         * Page form active changer
         */
         $('.form-active span').on('click', function () {
            let value = $(this).parent().find('input').val();
            if (value == 1) {
                $(this).parent().find('input').val(0);
            } else {
            ...
            let url = "{!! route('admin.pages.formActive', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
          ...
          /**
         * Doctor form active changer
         */
         $('.form-active-doctor span').on('click', function () {
            let value = $(this).parent().find('input').val();
            if (value == 1) {
                $(this).parent().find('input').val(0);
            } else {
            ...
            let url = "{!! route('admin.pages.formActiveDoctor', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
