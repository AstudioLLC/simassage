...
<form action="{!! $edit ? route('admin.advantages.edit', ['id' => $item->id]) : route('admin.advantages.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
            ...
            <div class="form-group border-bottom">
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->imageSmall))
                        ...
                        @imageDestroy([
                        'id' => $item->id,
                        'title' => __('app.Delete icon'),
                        'action' => route('admin.advantages.deleteImage')
                        ])@endimageDestroy
                    @endif
                </div>
            </div>
