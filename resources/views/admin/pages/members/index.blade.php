            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.doctors.onlyTrashed') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Trash') }}
                        </a>
                        <a href="{{ route('admin.doctors.create') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Create') }}
                        </a>
                    </div>
                </div>
...
{{--                        @dd($items)--}}
                        @include('admin.pages.members._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.members._script')
@endsection
