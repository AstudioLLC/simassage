...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.doctors.index') }}" class="btn btn-sm btn-neutral">
                            Doctors
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="table-responsive p-4">
                        @include('admin.pages.members.trash._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.members.trash._script')
@endsection
