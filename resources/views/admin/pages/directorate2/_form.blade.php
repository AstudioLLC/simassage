...
<form action="{!! $edit ? route('admin.directorate2.edit', ['id' => $item->id]) : route('admin.directorate2.store') !!}" method="post" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card-body">
                    ...
                    @if (!empty($item->image))
                        ...
                        @imageDestroy([
                            ...
                            'action' => route('admin.directorate2.deleteImage')
                            ])@endimageDestroy
                    @endif
                </div>
            </div>
