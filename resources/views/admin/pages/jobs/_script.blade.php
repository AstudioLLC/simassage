...
@push('js')
    ...
    <script>
        ...
        const showUrl = '{{ route('admin.job.show', ['id' => ':slug']) }}';
        ...
        const editUrl = '{{ route('admin.job.edit', ['id' => ':slug']) }}';
        ...
        $('.dataTable').dataTable({
            ...
            //order: [],
            ajax: {
                url: '{{ route('admin.job.listPortion') }}',
                type: 'POST',
                // data: function (e) {
        ...
        $(document).on('click', '.active-changer span', function() {
            ...
            let url = "{!! route('admin.job.active', ['id' => ':slug']) !!}";
        ...
        $('#itemDeleteForm').on('submit', function () {
            let url = "{!! route('admin.job.delete', ['id' => ':slug']) !!}";
            if (blocked) return false;
            blocked = true;
