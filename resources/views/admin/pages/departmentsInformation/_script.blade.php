...
@push('js')
    ...
    <script>
        ...
        {{--const showUrl = '{{ route('admin.events.show', ['id' => ':slug']) }}';--}}

        const galleryTooltip = '{!! __('app.Gallery') !!}';
        const galleryUrl = '{{ route('admin.gallery.index', ['gallery' => 'departmentsInformation', 'key' => ':slug']) }}';

        const editTooltip = '{!! __('app.Edit') !!}';
        const editUrl = '{{ route('admin.departmentsInformation.edit', ['id' => ':slug']) }}';
        ...
        $('.dataTable').dataTable({
            ...
            //order: [],
            ajax: {
                url: '{{ route('admin.departmentsInformation.listPortion') }}',
                type: 'POST',
                /*data: function (e) {
        ...
        $(document).on('click', '.active-changer span', function() {
            ...
            let url = "{!! route('admin.departmentsInformation.active', ['id' => ':slug']) !!}";
        ...
        $('#itemDeleteForm').on('submit', function () {
            let url = "{!! route('admin.departmentsInformation.delete', ['id' => ':slug']) !!}";
            if (blocked) return false;
            blocked = true;
