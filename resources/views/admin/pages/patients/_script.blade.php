...
@push('js')
    ...
    <script>
        ...
        const showUrl = '{{ route('admin.patient.show', ['id' => ':slug']) }}';
        ...
        const editUrl = '{{ route('admin.patient.edit', ['id' => ':slug']) }}';
        ...
        $('.dataTable').dataTable({
            ...
            //order: [],
            ajax: {
                url: '{{ route('admin.patient.listPortion') }}',
                type: 'POST',
                // data: function (e) {
        ...
        $(document).on('click', '.active-changer span', function() {
            ...
            let url = "{!! route('admin.patient.active', ['id' => ':slug']) !!}";
        ...
        $('#itemDeleteForm').on('submit', function () {
            let url = "{!! route('admin.patient.delete', ['id' => ':slug']) !!}";
            if (blocked) return false;
            blocked = true;
