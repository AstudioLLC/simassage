@push('js')
    <script>
        ...
        /**
         * Language default changer
         */
        $('.language-default span').on('click', function () {
            ...
            let url = "{!! route('admin.languages.default', ['id' => ':slug']) !!}";
        ...
        /**
         * Language admin changer
         */
        $('.language-admin span').on('click', function () {
            let value = $(this).parent().find('input').val();
            if (value == 1) {
                $(this).parent().find('input').val(0);
            } else {
            ...
            let url = "{!! route('admin.languages.admin', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
         ...
         */
        $('.language-url span').on('click', function () {
            let value = $(this).parent().find('input').val();
            if (value == 1) {
                $(this).parent().find('input').val(0);
            } else {
            ...
            let url = "{!! route('admin.languages.url', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
        ...
        /**
         * Language active changer
         */
        $('.language-active span').on('click', function () {
            let value = $(this).parent().find('input').val();
            if (value == 1) {
                $(this).parent().find('input').val(0);
            } else {
            ...
            let url = "{!! route('admin.languages.active', ['id' => ':slug']) !!}";
            var thisItemId = $(this).parents('tr').data('id');
        ...
        $('#itemDeleteForm').on('submit', function() {
            ...
            if (thisItemId && thisItemId.match(/^[1-9][0-9]{0,9}$/)) {
                ...
                let url = "{!! route('admin.languages.delete', ['id' => ':slug']) !!}";
