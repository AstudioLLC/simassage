...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-12 col-12 text-right">
                        <a href="{{ route('admin.administrators.create') }}" class="btn btn-sm btn-neutral">
                            {{ __('app.Create') }}
                        </a>
                    </div>
                </div>
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">{{ __('app.Administrators') }}</h3>
                    </div>
                    <div class="table-responsive p-4">
                        @include('admin.pages.administrators._table', ['items' => $items ?? null])
                    </div>
                </div>
    ...
    @include('admin.pages.administrators._script')
@endsection
...
@push('js')
    ...
    <script>
        ...
        $('.my-datatable').dataTable({
            ...
            "lengthMenu": [10, 25, 50, 100, 250, 500, 1000],
            ajax: {
                url: '{{ route('admin.retail-users.listPortion') }}',
                type: 'POST',
                /*data: function (e) {
                    return getSearchParams(e)
                }*/
