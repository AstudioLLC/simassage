...
Route::prefix('applyJobs')->name('applyJobs.')->group(function (Router $router) {
    $controller = 'ApplyJobsController@';
    ...
    $router->get('download/{id}', $controller . 'download')->name('download');
