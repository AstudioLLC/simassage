...
class QuestionController extends AdminBaseController
{
    ...
    {
        return response()
            ->view('admin.pages.question.index');
    }
    ...
    public function listPortion(Request $request)
    {
        ...
        $result->editColumn('active', function (Question $item) {
        ...
        $result->editColumn('title', function (Question $item) {
            return $item->title;
        });

        $result->editColumn('created_at', function (Question $item) {
    ...
    public function create()
    {
        ...
        return response()
            ->view('admin.pages.question.create', compact('edit', 'backUrl'));
    }
    ...
    public function edit(int $id)
    {
        ...
        return response()
            ->view('admin.pages.question.edit', compact('edit', 'backUrl', 'item'));
    }
    ...
    public function onlyTrashed()
    {
        ...
        return response()
            ->view('admin.pages.question.trash.index', compact('items'));
    }
