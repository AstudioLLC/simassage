...
use App\Http\Requests\Directorate\DeleteDirectoratesRequest;
...
class DirectorateController extends AdminBaseController
{
     ...
     * @var string
     */
    protected $modelClass = Directorate::class;
    ...
    {
        return response()
            ->view('admin.pages.directorate.index');
    }
    ...
    public function listPortion(Request $request)
    {
        ...
        $result->editColumn('name', function (Directorate $item) {
            return $item->name;
        });

        $result->editColumn('created_at', function (Directorate $item) {
    ...
    {
        $edit = false;
        $backUrl = route('admin.directorate.index');
        ...
        return response()
            ->view('admin.pages.directorate.create', compact('edit', 'backUrl', 'imageBigSize',));
    }
    ...
    public function edit(int $id)
    {
        ...
        return response()
            ->view('admin.pages.directorate.edit', compact('edit', 'backUrl', 'imageBigSize', 'item'));
    }
