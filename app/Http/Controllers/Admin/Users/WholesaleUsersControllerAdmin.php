...
class WholesaleUsersControllerAdmin extends AdminBaseController
{
    /**
    ...
    {
        $title = t('Admin header.Site users') . '*- Оптовики*';

        return view('admin.pages.users.wholesale.index', compact('title'));
    }
